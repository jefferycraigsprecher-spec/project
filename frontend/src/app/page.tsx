...
export default function MidwestHome() {
  return (
    <div className="bg-navy-50 text-slate-900 font-sans">
      <Navbar />
            ...
            <div className="space-y-8 rounded-[2rem] border border-slate-200 bg-white p-10 shadow-xl">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                  ...
                  <p className="mt-3 text-lg font-semibold text-slate-900">Next-day delivery on select routes.</p>
                </div>
                <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                  <p className="text-sm uppercase tracking-[0.28em] text-slate-500">Trusted operations</p>
                  <p className="mt-3 text-lg font-semibold text-slate-900">Track packages with real-time updates and alerts.</p>
                </div>
              </div>
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <Link href="/contact" className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-4 text-sm font-semibold text-slate-900 transition hover:bg-slate-100">
                  Request a quote
                </Link>
              </div>
            </div>
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
              <div className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-[1.5fr_1fr]">
                  <input
                    ...
                    className="w-full rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-slate-900 placeholder:text-slate-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20"
                  />
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                {stats.map((stat) => (
                  <div key={stat.label} className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
